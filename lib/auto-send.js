...
async function processDue() {
  // Kill-switch: als Robert de boel pauzeert (bv. na een verkeerde bulk-add),
  // blijven mails staan tot hij hervat. Pending-records worden niet aangeraakt.
  if (db.getSetting('send_paused') === '1') return;
